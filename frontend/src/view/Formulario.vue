          ...
          <v-expansion-panel v-model="panel[1]" expand class="panel">
            <v-expansion-panel-content>
              ...
              <v-layout align-center justify-center row wrap>
                <v-flex xs7 sm7 md3>
                  <v-text-field
                    ...
                    background-color="white"
                    label="Pseso Médio kg/cab"
                    box
                    v-model="formulario.touroPesoMedio"
                    required
                    lazy-validation
                  ></v-text-field>
                </v-flex>
                ...
                <v-flex xs6 sm6 md3>
                  <v-text-field
                    ...
                    box
                    v-model="formulario.touroCabecaInicial"
                    v-validate="'required'"
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Cabeças-Final"
                    box
                    v-model="formulario.touroCabecaFinal"
                    v-validate="'required'"
              ...
              <v-layout align-center justify-center row wrap>
                <v-flex xs7 sm7 md3>
                  <v-text-field
                    ...
                    label="Pseso Médio kg/cab"
                    box
                    v-model="formulario.vacaMatrizPesoMedio"
                    required
                    lazy-validation
                  ></v-text-field>
                </v-flex>
                ...
                <v-flex xs6 sm6 md3>
                  <v-text-field
                    ...
                    label="Cabeças-Inicial"
                    box
                    v-model="formulario.vacaMatrizCabecaInicial"
                    v-validate="'required'"
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Cabeças-Final"
                    box
                    v-model="formulario.vacaMatrizCabecaFinal"
                    v-validate="'required'"
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Valor R$/cab"
                    box
                    v-model="formulario.vacaMatrizValor"
                    v-validate="'required'"
              ...
              <v-layout align-center justify-center row wrap>
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    box
                    v-model="formulario.femeas36PesoInicial"
                    required
                    lazy-validation
                  ></v-text-field>
                </v-flex>
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Peso(kg)Final"
                    box
                    v-model="formulario.femeas36PesoFinal"
                    v-validate="'required'"
                ...
                <v-flex xs6 sm6 md3>
                  <v-text-field
                    ...
                    box
                    v-model="formulario.femeas36Valor"
                    v-validate="'required'"
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    box
                    v-model="formulario.femeas36CabecasInicial"
                    v-validate="'required'"
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Cabecas-Final"
                    box
                    v-model="formulario.femeas36CabecasFinal"
                    v-validate="'required'"
              ...
              <v-layout align-center justify-center row wrap>
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Peso(kg)Inicial"
                    box
                    v-model="formulario.femeas2436PesoInicial"
                    required
                    lazy-validation
                  ></v-text-field>
                </v-flex>
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Peso(kg)Final"
                    box
                    v-model="formulario.femeas2436PesoFinal"
                    v-validate="'required'"
                ...
                <v-flex xs6 sm6 md3>
                  <v-text-field
                    ...
                    label="Valor R$/Kg Vivo"
                    box
                    v-model="formulario.femeas2436Valor"
                    v-validate="'required'"
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Cabecas-Inicial"
                    box
                    v-model="formulario.femeas2436CabecasInicial"
                    v-validate="'required'"
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Cabecas-Final"
                    box
                    v-model="formulario.femeas2436CabecasFinal"
                    v-validate="'required'"
              ...
              <v-layout align-center justify-center row wrap>
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Peso(kg)Inicial"
                    box
                    v-model="formulario.femeas1224PesoInicial"
                    required
                    lazy-validation
                  ></v-text-field>
                </v-flex>
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Peso(kg)Final"
                    box
                    v-model="formulario.femeas1224PesoFinal"
                    v-validate="'required'"
                ...
                <v-flex xs6 sm6 md3>
                  <v-text-field
                    ...
                    label="Valor R$/Kg Vivo"
                    box
                    v-model="formulario.femeas1224Valor"
                    v-validate="'required'"
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Cabecas-Inicial"
                    box
                    v-model="formulario.femeas1224CabecasInicial"
                    v-validate="'required'"
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Cabecas-Final"
                    box
                    v-model="formulario.femeas1224CabecasFinal"
                    v-validate="'required'"
              ...
              <v-layout align-center justify-center row wrap>
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Peso(kg)Inicial"
                    box
                    v-model="formulario.femeas012PesoInicial"
                    required
                    lazy-validation
                  ></v-text-field>
                </v-flex>
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Peso(kg)Final"
                    box
                    v-model="formulario.femeas012PesoFinal"
                    v-validate="'required'"
                ...
                <v-flex xs6 sm6 md3>
                  <v-text-field
                    ...
                    label="Valor R$/Kg Vivo"
                    box
                    v-model="formulario.femeas012Valor"
                    v-validate="'required'"
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Cabecas-Inicial"
                    box
                    v-model="formulario.femeas012CabecasInicial"
                    v-validate="'required'"
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Cabecas-Final"
                    box
                    v-model="formulario.femeas012CabecasFinal"
                    v-validate="'required'"
              ...
              <v-layout align-center justify-center row wrap>
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Peso(kg)Inicial"
                    box
                    v-model="formulario.machos012PesoInicial"
                    required
                    lazy-validation
                  ></v-text-field>
                </v-flex>
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Peso(kg)Final"
                    box
                    v-model="formulario.machos012PesoFinal"
                    v-validate="'required'"
                ...
                <v-flex xs6 sm6 md3>
                  <v-text-field
                    ...
                    label="Valor R$/Kg Vivo"
                    box
                    v-model="formulario.machos012Valor"
                    v-validate="'required'"
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Cabecas-Inicial"
                    box
                    v-model="formulario.machos012CabecasInicial"
                    v-validate="'required'"
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Cabecas-Final"
                    box
                    v-model="formulario.machos012CabecasFinal"
                    v-validate="'required'"
              ...
              <v-layout align-center justify-center row wrap>
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Peso(kg)Inicial"
                    box
                    v-model="formulario.machos1224PesoInicial"
                    required
                    lazy-validation
                  ></v-text-field>
                </v-flex>
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Peso(kg)Final"
                    box
                    v-model="formulario.machos1224PesoFinal"
                    v-validate="'required'"
                ...
                <v-flex xs6 sm6 md3>
                  <v-text-field
                    ...
                    label="Valor R$/Kg Vivo"
                    box
                    v-model="formulario.machos1224Valor"
                    v-validate="'required'"
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Cabecas-Inicial"
                    box
                    v-model="formulario.machos1224CabecasInicial"
                    v-validate="'required'"
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Cabecas-Final"
                    box
                    v-model="formulario.machos1224CabecasFinal"
                    v-validate="'required'"
              ...
              <v-layout align-center justify-center row wrap>
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Peso(kg)Inicial"
                    box
                    v-model="formulario.machos2436PesoInicial"
                    required
                    lazy-validation
                  ></v-text-field>
                </v-flex>
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Peso(kg)Final"
                    box
                    v-model="formulario.machos2436PesoFinal"
                    v-validate="'required'"
                ...
                <v-flex xs6 sm6 md3>
                  <v-text-field
                    ...
                    label="Valor R$/Kg Vivo"
                    box
                    v-model="formulario.machos2436Valor"
                    v-validate="'required'"
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Cabecas-Inicial"
                    box
                    v-model="formulario.machos2436CabecasInicial"
                    v-validate="'required'"
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Cabecas-Final"
                    box
                    v-model="formulario.machos2436CabecasFinal"
                    v-validate="'required'"
              ...
              <v-layout align-center justify-center row wrap>
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Peso(kg)Inicial"
                    box
                    v-model="formulario.machos36PesoInicial"
                    required
                    lazy-validation
                  ></v-text-field>
                </v-flex>
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Peso(kg)Final"
                    box
                    v-model="formulario.machos36PesoFinal"
                    v-validate="'required'"
                ...
                <v-flex xs6 sm6 md3>
                  <v-text-field
                    ...
                    label="Valor R$/Kg Vivo"
                    box
                    v-model="formulario.machos36Valor"
                    v-validate="'required'"
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Cabecas-Inicial"
                    box
                    v-model="formulario.machos36CabecasInicial"
                    v-validate="'required'"
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    label="Cabecas-Final"
                    box
                    v-model="formulario.machos36CabecasFinal"
                    v-validate="'required'"
              ...
              <v-layout align-center justify-center row wrap>
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    type="number"
                    v-validate="'required'"
                    :error-messages="errors.collect('rebanhoMedioAnualEstimadoCabeca')"
                    data-vv-name="rebanhoMedioAnualEstimadoCabeca"
                    background-color="white"
                    label="Peso(kg)Inicial"
                    box
                ...
                <v-flex xs6 sm6 md2>
                  <v-text-field
                    ...
                    v-validate="'required'"
                    :error-messages="errors.collect('rebanhoMedioAnualEstimadoUA')"
                    data-vv-name="rebanhoMedioAnualEstimadoUA"
                    required
                    lazy-validation
                  ></v-text-field>
                </v-flex>
              ...
              <v-btn
                ...
                type="submit"
                color="primary"
              >Visualizar Relatório !{{form}} </v-btn>
  ...
  computed:{
    form:function(){
       ...
       var db = new Dexie("simulacao");
          ...
          db.simulacao.get(1).then((f)=> this.formulario = new Formulario(f.formularioDB) );
    ...
    grava() {
      this.$validator.validateAll().then(valid => {
        if (!valid) {
          ...
          db.simulacao.put({id :1,formularioDB: this.formulario}).then (function(){
